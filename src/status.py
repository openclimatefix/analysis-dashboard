...
def status_page():
    ...
    # example messages
    st.write("We are doing some upgrades, and dont expect any downtime. "
             "We will keep you informed if anything changes")

    st.write("We are experiencing some issues, "
             "and we are current investigating the issue.")

    st.write("We are experiencing some issues with the Forecast, "
    ...
    st.write(f"We experienced some issues with the Forecast on {datetime.now().date()}. "
